...
// const BookModal: React.FC<ModalProps> = ({ isOpen, onClose, books, onSelectBook }) => {
//     return (
...
//                         <Dialog.Title className="text-xl font-semibold">Select a Book</Dialog.Title>
//                         <div className="mt-4 max-h-80 overflow-y-auto">
//                             <ul className="space-y-4">
//                                 {books.map((book) => (
//                                     <li key={book.id} className="flex items-center p-2 border border-gray-200 rounded cursor-pointer hover:bg-gray-100" onClick={() => onSelectBook(book)}>
//                                         {book.imageLinks?.thumbnail ? (
//                                             <Image src={book.imageLinks.thumbnail} alt={book.title} width={64} height={64} className="rounded-md object-cover mr-4" />
//                                         ) : (
