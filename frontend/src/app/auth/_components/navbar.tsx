    ...
    <header className="flex items-center justify-between bg-primary px-4 py-3 text-primary-foreground">
      <div className="flex items-center gap-4">
        ...
        <nav className="hidden md:flex items-center gap-4">
          ...
          <button
            onClick={() => setActivePage("book-registration")}
            className="hover:underline"
          >
            Register a Book
          </button>
          <button
            onClick={() => setActivePage("view-registered-books")}
            className="hover:underline"
          >
            View Registered Books
          </button>
          <button
            onClick={() => setActivePage("manage-books")}
            className="hover:underline"
          >
            Manage Books
          </button>
          <button
            onClick={() => setActivePage("my-offers")}
            className="hover:underline"
          >
            My Offers
          </button>
        ...
        <div className="md:hidden flex items-center gap-4 relative">
          ...
          {isDropdownOpen && (
            ...
            >
              ...
              <button
                onClick={() => {
                  setActivePage("book-registration");
                  setDropdownOpen(false);
                }}
                className="block px-4 py-2 hover:bg-gray-100 w-full text-left"
              >
              ...
              <button
                onClick={() => {
                  setActivePage("view-registered-books");
                  setDropdownOpen(false);
                }}
                className="block px-4 py-2 hover:bg-gray-100 w-full text-left"
              >
